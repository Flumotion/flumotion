...
CONVERTER_PIPELINE_ = '@producer1 ! ffmpegcolorspace ! theoraenc ! queue name=video } { @producer2 ! audioconvert ! rawvorbisenc ! queue name=audio } video.src ! { oggmux name=muxer audio.src ! identity ! muxer. muxer.'
CONVERTER_PIPELINE = '@producer1 ! identity ! queue name=video } { @producer2 ! identity ! queue name=audio } video.src ! { oggmux name=muxer audio.src  ! muxer. muxer.'
